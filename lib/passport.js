...
var Passport = function () {
    ...
    passport.use(new QqStrategy({
            ...
            callbackURL: 'http://passport.example.com/auth/qq/callback'
    ...
    passport.use(new WechatStrategy({
            ...
            callbackURL: 'http://passport.example.com/auth/wechat/callback',
            scope: 'snsapi_base',
            state: true
    ...
    passport.use(new WeiboStrategy({
            ...
            callbackURL: 'http://passport.example.com/auth/weibo/callback'
        },
        function (accessToken, refreshToken, profile, done) {
